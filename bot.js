...
robot.on("ready", function() {
    ...
    console.log('Clatcher Младший на связи! (c) ' + robot.user.username);
});

robot.on('message', (msg) => { // Реагирование на сообщения, разбивает на подслова, выделяя команду и выполняя её
